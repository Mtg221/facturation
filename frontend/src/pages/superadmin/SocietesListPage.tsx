  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          onClick={() => navigate(ROUTES.SUPERADMIN_SOCIETE_CREATE)}
        ...
        {societes.map((s) => (
          ...
          >
            ...
            <div className="flex items-center gap-6">
              ...
              <span className={`px-2.5 py-1 rounded-full text-xs font-medium ${s.isActive ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'}`}>
